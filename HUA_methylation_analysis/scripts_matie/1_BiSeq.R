...
dir.create("rrbs_clean_data_matie")
saveRDS(rrbs, "rrbs_clean_data_matie/rrbs.RDS")

# pdf('rrbs_covBoxplots.pdf', paper = 'a4r', width = 0, height = 0)
png("rrbs_clean_data_matie/rrbs_covBoxplots.png", width = 900, height = 480, units = 'px', pointsize = 12)
...
saveRDS(rrbs.clust.lim, 'rrbs_clean_data_matie/rrbs.clust.lim.RDS')

# pdf('rrbs.clust.lim_covBoxplots.pdf', paper = 'a4r', width = 0, height = 0)
png('rrbs_clean_data_matie/rrbs.clust.lim_covBoxplots.png', width = 900, height = 480, units = 'px', pointsize = 12)
covBoxplots(rrbs.clust.lim, col = "cornflowerblue", las = 2)
dev.off()

predictedMeth <- predictMeth(object = rrbs.clust.lim, mc.cores = 1)
saveRDS(predictedMeth, 'rrbs_clean_data_matie/predictedMeth.RDS')
