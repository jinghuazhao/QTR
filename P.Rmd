...
p
```
Consequently, the effect of `Days` on `Reaction` became less pronounced after accounting for individual differences -- as we saw a larger standard error for `Days`.
