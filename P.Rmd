...
```
the F statistics which is simply $t^2$. Next we turn to the mixed model containing a random effect
```{r}
...
p
```
We can see that the P values from two models are very close, giving a sense of what they do.
