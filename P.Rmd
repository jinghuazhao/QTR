...
```{r}
require(lme4)
boxplot(Reaction~Days, data=sleepstudy, main="Reaction by Days", xlab="Days", ylab="Reaction",
...
```{r}
boxplot(Reaction~Subject, data=sleepstudy, main="Reaction by Subject", xlab="Subject", ylab="Reaction",
